...
*   **Dimensions:** The dimensions specified in `src/config.py` (`helpfulness`, `correctness`, `coherence`, `verbosity`) were used, with concise definitions provided to the judge.
